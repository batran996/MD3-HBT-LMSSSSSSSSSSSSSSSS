            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <img width="150px" height="150px" style="border-radius: 50%" src="${requestScope["avatar"]}" alt="">
                        <h5 class="my-3">${user.name}</h5>
                        <p class="text-muted mb-1">Full Stack Developer</p>
                        <div class="d-flex justify-content-center mb-2">
                            <a href="users?action=change_avatar"><button class="btn btn-outline-primary ms-1">CHANGE AVATAR</button></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush rounded-3">
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                ...
                                <p class="mb-0">https://rikkei.academy.edu</p>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center p-3">
